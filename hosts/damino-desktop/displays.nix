...
{ config, pkgs, inputs, lib, ... }: {
  hardware = {
    ...
    display = {
      ...
      outputs."DP-1".mode = "e";
      outputs."DP-3".edid = "edid_qm851g.bin"; # Fix 1440p144hz, VRR to 70+ to work around judder (LFC instead), prevent blanking (48 -> 40 FRL), HDR Metadata MaxFALL 800 MaxCLL 3000 MinCLL 0.1
      outputs."DP-3".mode = "e";
      #outputs."DP-3".edid = "edid_55r635.bin"; # Add VRR range (48-120), EDID MaxFALL 686 MaxCLL 1114 MinCLL 0.1
      outputs."HDMI-A-1".edid = "edid_g8_xiaomi_lumi.bin"; # For "headless" streaming through unused DP port on GPU. 2024 Odyssey G8 OLED (4k240) w/ Xiaomi G Pro 27i's luminance metadata
