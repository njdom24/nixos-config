...
{ config, pkgs, inputs, lib, ... }: {
  hardware = {
    ...
    display = {
      ...
      outputs."DP-3".edid = "edid_qm851g_hdr_vrr.bin"; # Add VRR range (48-120), EDID MaxFALL 686 MaxCLL 1114 MinCLL 0.1
      ...
      edid.packages = [
        (pkgs.runCommand "custom-edid" {} ''
          ...
          cp ${./edid_qm851g_v217.bin} $out/lib/firmware/edid/edid_qm851g_v217.bin
          cp ${./edid_qm851g_hdr_vrr.bin} $out/lib/firmware/edid/edid_qm851g_hdr_vrr.bin
