      ...
      package = pkgs.steam.override {
        ...
        extraProfile = ''
          ...
          if [ "$XDG_CURRENT_DESKTOP" = "gamescope" ]; then
            # Launched through gamescope. Could enable after https://github.com/Supreeeme/extest/issues/11
            # or portal issue: https://github.com/emersion/xdg-desktop-portal-wlr/issues/278
