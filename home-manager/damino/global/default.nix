...
# Use this to configure your home environment (it replaces ~/.config/nixpkgs/home.nix)
{
  ...
  imports = [
    ...
    # Or modules exported from other flakes (such as stylix):
  ...
  stylix = {
    # Don't let Stylix auto-style every detected program
    autoEnable = false;
  ...
  home = {
    ...
    sessionVariables = {
      ...
      LD_LIBRARY_PATH = "$LD_LIBRARY_PATH:${pkgs.libx11}/lib"; # Fixed MangoHud for Wayland apps: https://github.com/ValveSoftware/gamescope/pull/1666 https://github.com/flightlessmango/MangoHud/issues/1497
    };
