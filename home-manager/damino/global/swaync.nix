      ...
      style = ''
        ...
        * {
        ...
        .notification-background {
          ...
          border-radius: 6.6px;
          margin: 18px;
          background-color: rgba(${config.lib.stylix.colors.base00-rgb-r}, ${config.lib.stylix.colors.base00-rgb-g}, ${config.lib.stylix.colors.base00-rgb-b}, 0.9); /* base00 with 90% opacity */
          color: var(--base05);
          padding: 0;
        }
        ...
        .control-center {
          ...
          border-radius: 12.6px;
          background-color: rgba(${config.lib.stylix.colors.base00-rgb-r}, ${config.lib.stylix.colors.base00-rgb-g}, ${config.lib.stylix.colors.base00-rgb-b}, 0.95); /* base00 with 95% opacity */
          color: var(--base05);
          padding: 14px;
        }
